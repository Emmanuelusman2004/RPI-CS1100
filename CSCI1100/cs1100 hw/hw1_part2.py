...
pace_sec = (pace_secdec * 60) #gives me flat number of seconds with no decimal
...
#print statements
print("Pace is", pace_min, "minutes and", int(pace_sec), "seconds per mile.")
print("Speed is", format(speed, '.2f'), "miles per hour.")
print("Time to run the target distance of", format(target_miles,'.2f'),"miles is", proj_mins, "minutes and", proj_sec_int,"seconds.")
