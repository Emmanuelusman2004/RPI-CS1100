# -*- coding: utf-8 -*-
"""
Created on Wed Dec  7 13:46:25 2022
...
if __name__ == "__main__":
    ...
    ball = []
    for i in range(0, 10):
        one_ball = Ball(random.randint(10,390), random.randint(10,390),random.randint(-8,8), random.randint(-8,8), random.randint(5,10),random.choice(colorList))
